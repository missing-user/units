const energycomparisions = {
  ...
  'the kinetic energy of a dust particle in a severe tornado': 1.44e-7,
  'the kinetic energy of a flying mosquito': 1.6e-7,
  'the kinetic energy of a walking ant': 1.28e-5,
  'the potential energy of an ant at 1m height': 4.9e-5,
  'the acoustic energy of a whisper': 1e-2,
  'the potential energy of an ant on mount everest': 0.434,
  'the amount of energy to lift a bar of chocolate 1m': 0.981,
  'the kinetic energy of a housefly caught in a strong wind': 1.839,
  'a single calorie': 4.19,
  'the nutritional energy of a peanut': 11.88,
  'the energy consumed by your brain each second': 20,
  'the energy of an amateur punch': 40,
  'the energy consumed by your fridge every second': 50.22,
  'the kinetic energy of tennis ball at serve': 116,
  'the energy required to ascend a flight of stairs': 5520,
  'the kinetic energy of Usain Bolt at top speed': 6192,
  'the nutritional energy of a Tic Tac': 8e3,
...
const sizecomparisions = {
  ...
  'the size of a large red ant': 5e-3,
  "the size of a milky way (candy bar)": 0.08,
  "the size of a Coke can": 0.122682,
  ...
  'the length of a banana': 0.1778,
  'the width of an A4 paper': 0.21,
  'the length of an A4 paper': 0.297,
  'the average height of a Dutch person': 1.84,
  'the average height of a German': 1.8,
...
const weightcomparisions = {
  ...
  'the weight of a Nintendo DS': 0.7711,
  ...
  'the weight of an average skyscraper': 222.5e6,
...
function initComparisions(comparisions, idsuffix) {
  ...
  randomVal = (~~(1 + 9 * Math.random()) * 10 ** ~~(Math.random() * 7 - 2)) //random initial values for the fields
  document.getElementById("input" + idsuffix).value = randomVal
  convert(tmpObj)
